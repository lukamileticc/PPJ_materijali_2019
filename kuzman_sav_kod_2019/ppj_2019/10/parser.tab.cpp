...
#line 153 "parser.tab.cpp" /* yacc.c:355  */
};
...
static const yytype_uint8 yytranslate[] =
{
      ...
      13,     2,     2,     2,     2,     2,     2,     2,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
       2,     2,     2,     2,     2,     2,    18,     2,     2,     9,
      16,    17,     7,     5,    22,     6,     2,     2,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
...
{
       0,    55,    55,    56,    58,    62,    70,    80,    90,    92,
      93,    94,    95,    96,    97,    98,    99,   110,   112,   114,
     115
};
#endif
...
{
  "$end", "error", "$undefined", "EQ", "NEQ", "'+'", "'-'", "'*'",
  "UMINUS", "'\\''", "DODELA", "BROJ", "ID", "'\\n'", "'['", "']'", "'('",
  "')'", "'$'", "'|'", "'<'", "'>'", "','", "$accept", "program",
  "naredba", "izraz", "polinom", "lista", YY_NULLPTR
};
#endif
...
{
       0,   256,   257,   258,   259,    43,    45,    42,   260,    39,
     261,   262,   263,    10,    91,    93,    40,    41,    36,   124,
      60,    62,    44
};
# endif
...
{
      11,    18,    -9,    18,    18,    -2,    25,    15,     1,   -10,
     -10,    23,    18,    34,     7,   -10,    28,   -10,    11,    18,
      18,    18,    18,    18,   -10,    31,    39,   -10,    36,   -10,
      41,   -10,    39,    39,    26,    26,    23,    22,   -10,   -10,
     -10
};
...
{
       3,     0,    16,     0,     0,     0,     0,     0,     4,    17,
      16,    12,     0,     0,     0,    20,     0,     1,     3,     0,
       0,     0,     0,     0,    14,     0,     5,    13,     0,    18,
       0,     2,     6,     7,     9,    10,    11,     0,    15,    19,
       8
};
...
{
      11,    12,    13,    14,    19,    20,    21,    22,    23,    15,
      24,    26,    21,    22,    23,    25,    24,     1,    32,    33,
      34,    35,    36,     2,     1,    17,    28,     3,    18,     4,
      10,     5,    24,    23,     3,    24,     4,    40,     5,    21,
      22,    23,    37,    24,    21,    22,    23,    38,    24,    29,
      30,    27,    39,    31
};

static const yytype_uint8 yycheck[] =
{
       1,    10,     3,     4,     3,     4,     5,     6,     7,    11,
       9,    12,     5,     6,     7,    14,     9,     6,    19,    20,
      21,    22,    23,    12,     6,     0,    19,    16,    13,    18,
      12,    20,     9,     7,    16,     9,    18,    15,    20,     5,
       6,     7,    11,     9,     5,     6,     7,    11,     9,    21,
      22,    17,    11,    18
};
...
{
       0,     6,    12,    16,    18,    20,    24,    25,    26,    27,
      12,    26,    10,    26,    26,    11,    28,     0,    13,     3,
       4,     5,     6,     7,     9,    14,    26,    17,    19,    21,
      22,    24,    26,    26,    26,    26,    26,    11,    11,    11,
      15
};
...
#line 58 "parser.ypp" /* yacc.c:1646  */
    {	
							//cout<<"Stampam"<<endl;
							cout<<(*(yyvsp[0].p))<<endl; delete (yyvsp[0].p); 
						}
...
#line 62 "parser.ypp" /* yacc.c:1646  */
    {	
							...
							promenljive[*(yyvsp[-2].ime)] = (yyvsp[0].p);
							delete (yyvsp[-2].ime);
						}
#line 1290 "parser.tab.cpp" /* yacc.c:1646  */
    break;

  case 6:
#line 70 "parser.ypp" /* yacc.c:1646  */
    { 	
							if (*(yyvsp[-2].p) == *(yyvsp[0].p)) {
								cout<<"True"<<endl;
							}
							else {
								cout<<"False"<<endl;
...
#line 90 "parser.ypp" /* yacc.c:1646  */
    { cout<<((yyvsp[-3].p)->valueAt((yyvsp[-1].x)))<<endl; delete (yyvsp[-3].p);}
#line 1326 "parser.tab.cpp" /* yacc.c:1646  */
    break;

  case 9:
#line 92 "parser.ypp" /* yacc.c:1646  */
    { (yyval.p) = *(yyvsp[-2].p) + *(yyvsp[0].p); delete (yyvsp[-2].p); delete (yyvsp[0].p); }
...
#line 95 "parser.ypp" /* yacc.c:1646  */
    { (yyval.p) = -(*(yyvsp[0].p)); delete (yyvsp[0].p);}
...
#line 97 "parser.ypp" /* yacc.c:1646  */
    { (yyval.p) = (yyvsp[-1].p)->izvod(); delete (yyvsp[-1].p);}
#line 1362 "parser.tab.cpp" /* yacc.c:1646  */
    break;

  case 15:
#line 98 "parser.ypp" /* yacc.c:1646  */
    {(yyval.p) = (yyvsp[-2].p)->integral((yyvsp[0].x)); delete (yyvsp[-2].p);}
...
#line 114 "parser.ypp" /* yacc.c:1646  */
    {(yyvsp[-2].p) -> insert((yyvsp[0].x)); (yyval.p) = (yyvsp[-2].p);}
#line 1402 "parser.tab.cpp" /* yacc.c:1646  */
    break;

  case 20:
#line 115 "parser.ypp" /* yacc.c:1646  */
    {(yyval.p) = new Polinom(); (yyval.p)->insert((yyvsp[0].x));}
...
#line 118 "parser.ypp" /* yacc.c:1906  */
