...
{
       0,    54,    54,    55,    57,    66,    79,    83,    87,    96,
     106,   118,   119,   120,   121,   129,   132,   140,   142,   144,
     145
};
#endif
...
#line 121 "parser.ypp" /* yacc.c:1646  */
    {
						...
						(yyval.s) = uniSet->komplement(*(yyvsp[0].s));
						delete (yyvsp[0].s);
					}
...
#line 148 "parser.ypp" /* yacc.c:1906  */
